...
clip6.addIncident(moveLeft("0%",".background-container",2800,0,"easeInOutCubic"),0)
clip6.addIncident(moveLeft("-40%",".face-container",3000,0,"easeInOutCubic"),400)
clip6.addIncident(moveLeft("-30%",".face-container",3200),4800)
clip6.addIncident(moveTop("0px",".letter",300,"@stagger(0,600)","easeOutSine"),2700)
clip6.addIncident(opacity(1,".letter",300,"@stagger(0,600)"),2700)
clip6.addIncident(moveTop("0px",".word",400,"@stagger(0,700)","easeOutSine"),3600)
clip6.addIncident(opacity(1,".word",400,"@stagger(0,700)"),3600)
clip6.addIncident(moveRight("30%",".bg-text-container",5300),500)
...
clip6.addIncident(moveRight("0%",".text-container",2000),4800)
