...
clip7.addIncident(moveTop("0%",".background-container",2800,0,"easeInOutCubic"),0)
clip7.addIncident(moveTop("-30%",".face-container",2800,0,"easeInOutCubic"),400)
clip7.addIncident(moveTop("-20%",".face-container",3200),4800)
clip7.addIncident(moveTop("0px",".letter",300,"@stagger(0,600)","easeOutSine"),2700)
clip7.addIncident(opacity(1,".letter",300,"@stagger(0,600)"),2700)
clip7.addIncident(moveTop("0px",".word",400,"@stagger(0,700)","easeOutSine"),3600)
...
clip7.addIncident(moveBottom("-10%",".text-container",2000),4800)
